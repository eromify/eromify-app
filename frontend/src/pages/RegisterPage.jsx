...
const RegisterPage = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔍 [RegisterPage mount] Checking returnTo:', savedReturnTo)
      ...
      if (referrer) {
        try {
          ...
          if (AI_GIRLFRIEND_PAGES.some(page => referrerPath.startsWith(page))) {
            ...
            console.log('🔍 [RegisterPage mount] Saved returnTo from referrer:', referrerPath)
      ...
      if (error) {
        ...
        setTimeout(async () => {
          try {
            ...
            console.log('🔄 [RegisterPage] Redirecting to:', redirectPath, { hasPaid, returnTo })
            ...
            console.log('🔄 [RegisterPage Error] Redirecting to:', redirectPath, { returnTo })
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Check if we already have a return path saved (from clicking Get Started on AI girlfriend page)
    let returnPath = sessionStorage.getItem('aiGirlfriendReturnTo')
    console.log('🔍 [RegisterPage Google] Checking return path:', returnPath)
      ...
      if (referrer) {
        try {
          ...
          if (AI_GIRLFRIEND_PAGES.some(page => referrerPath.startsWith(page))) {
            ...
            console.log('🔍 [RegisterPage Google] Saved return path from referrer:', returnPath)
          }
        } catch (e) {
          console.log('Could not parse referrer:', e)
        }
    ...
    try {
      console.log('🚀 [RegisterPage Google] Starting OAuth with return path:', returnPath)
