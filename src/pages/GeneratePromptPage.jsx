        ...
        <div className="fixed bottom-0 left-56 right-80 bg-black border-t border-gray-900 p-4">
          <div className="flex justify-center items-center space-x-4">
            <button 
              ...
              className="bg-black border border-gray-700 text-white px-6 py-2 rounded-lg font-semibold hover:bg-gray-800 transition-all duration-200 flex items-center"
            >
